    ...
    fetch(`${serverURL}/games`)
        ...
        .then(object0 => {
                        ...
                        fetch(`${serverURL}/Saved_Games`)
                            ...
                            .then(object2 => {
                                for (let element0 of object2) {
                                    ...
                                    backbttn.setAttribute("id", "expendable");
                                    backbttn.innerText = "Close";
                                    const div0 = document.createElement("div");
                                ...
                                for (let element0 of backToMain) {
                                    element0.addEventListener("click", () => {
                                        ...
                                        handleClick0("savedGamesDivAndElems");
            ...
            toSavedGames.addEventListener("click", () => {
                ...
                handleClick0("savedGamesBack", "unhide");
                ...
                fetch(`${serverURL}/Saved_Games`)
                    ...
                    .then(object2 => {
                        ...
                        const backbttn = document.querySelector("button#savedGamesBack")
                        ...
                        for (let element0 of object2) {
                            ...
                            for (let element0 of backToMain) {
                                element0.addEventListener("click", () => {
                                    ...
                                    handleClick0("listDiv", "hide");
                                    handleClick0("savedGamesBttn", "unhide");
                                    handleClick0("savedGamesBack","hide");
                                    handleClick0("savedGamesDivAndElems");
                                    handleClick0("imgSlider", "unhide");
                                })
                            }
...
function handleClick0(var0, val0) {
    ...
    const hideUnhide = (arr, val) => {
        if (val === "hide") {
            ...
            for (let element0 of arr) {
                element0.removeAttribute("hidden"); const allElemsCreated = document.querySelectorAll("div.created");
            }
    ...
    if (var0 === "gameDisplayDiv") {
    ...
    } else if (var0 === "savedGamesBack") {
        const savedGamesBack = document.querySelector("button#savedGamesBack");

        let newArr8 = new Array();
        newArr8.push(savedGamesBack);
        hideUnhide(newArr8, `${val0}`);
        ...
        newArray10.push(savedGameDiv, savedGamesBack);
        hideUnhide(newArray10, `${val0}`);
    } else if (var0 === "savedGamesDivAndElems") {
        const created0 = document.querySelectorAll("div.created0");
        const created1 = document.querySelector("p.created1");
        const created2 = document.querySelector("img.created2")
        const created3 = document.querySelector("div.created3");
        const created4 = document.querySelector("p.created4");
        const created5 = document.querySelector("p.created5");
        const created6 = document.querySelector("p.created6");
        const created7 = document.querySelector("p.created7");
        const created8 = document.querySelector("p.created8");
        const created9 = document.querySelector("p.created9");
        const created10 = document.querySelector("p.created10");

        console.log(created0);
        let newArray11 = new Array();

        const remover = (arr) => {
            let newArray12 = new Array();
            for (let element of arr) {
                newArray12.push(element);
            }
            for (let element of newArray12) {
                element.remove();
            }
            return newArray12;
        }

        newArray11.push(created0, created1, created2, created3, created4, created5, created6, created7, created8, created9, created10);
        console.log(newArray11)
        for (let element of newArray11) {
            remover(element);
        }
    }
}
